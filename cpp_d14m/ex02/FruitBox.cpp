...
// Last update Tue Jan 17 21:42:01 2017 Carl DEBRAUWERE
*/
...
bool FruitBox::checkDoubleFruit(const Fruit *f){
...
bool FruitBox::putFruit(const Fruit *f){
  ...
  tmp->next->next = 0;
  tmp->next->data = const_cast<Fruit *>(f);;
  _nbFruits++;
  return true;
